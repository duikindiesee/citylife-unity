...
def self_test():
    ...
    print('Package guard canaries passed: checksum tampering, path escape, private state, Unity backup, licence file and case-insensitive duplicate rejected. Fixtures were temporary and are not builds.')
